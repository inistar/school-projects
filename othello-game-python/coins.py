...
class CoinsState:
    def __init__(self, game_board):
        ...
        there are no spots.
        '''
        self._coins = game_board


    def all_coins(self) -> [Coins]:
    ...
    def handle_click(self, click_point: point.Point) -> None:
        ...
        for i in reversed(range(len(self._coins))):
            if self._coins[i].contains(click_point):
        ...
        self._coins.append(Coins(click_point, COIN_RADIUS_FRAC))
